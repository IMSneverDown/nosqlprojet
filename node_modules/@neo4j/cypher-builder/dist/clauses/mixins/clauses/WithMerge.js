...
exports.WithMerge = void 0;
const __1 = require("../../..");
const Mixin_1 = require("../Mixin");
class WithMerge extends Mixin_1.MixinClause {
    ...
    merge(clauseOrPattern) {
        if (clauseOrPattern instanceof __1.Merge) {
            this.addNextClause(clauseOrPattern);
            return clauseOrPattern;
        }
        const matchClause = new __1.Merge(clauseOrPattern);
        this.addNextClause(matchClause);
        return matchClause;
    }
}
exports.WithMerge = WithMerge;
